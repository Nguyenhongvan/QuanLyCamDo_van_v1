		        ...
		        <div class="modal-body" style="padding:40px 50px;">
		        	<html:form action="/dangnhaphethong" method="post" acceptCharset="UTF-8">
		        		<div class="form-group">
		              		<label for="taiKhoan"><span class="fa fa-user" aria-hidden="true"></span> Tài khoản </label>
		              		<html:text property="taiKhoan" styleClass="form-control" styleId="tkhoan"></html:text>
		            	</div>
		            	<div class="form-group">
		            		<label for="matKhau"><span class="fa fa-user" aria-hidden="true">Mật khẩu</span></label>
